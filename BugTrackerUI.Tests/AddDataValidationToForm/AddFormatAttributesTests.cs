    ...
    public class M5_02_AddFormatAttributesTests
    {
        ...
        public void AddFormatAttributesTest()
        {
            ...
            var descriptionRequired =
                descriptionAttributes.FirstOrDefault(x => x.AttributeType == typeof(MinLengthAttribute));
            Assert.True(descriptionRequired != null,
                "The `Description` property of the `Bug` class should be marked with the `[MinLength]` attribute.");
            ...
            Assert.True(priorityRequired != null,
                "The `Priority` property of the `Bug` class should be marked with the `[Range]` attribute.");
        }
    }
}